    ...
    >
      ...
      >
        ...
        <div 
          ...
          :class="state.type === 'confirm' ? 'bg-[#FDE047]' : 'bg-[#FF3D8B]'"
        ></div>
        ...
        <div class="p-6">
          <div class="flex items-start gap-4">
            ...
            <div 
              ...
              :class="state.type === 'confirm' ? 'bg-[#FDE047]/10' : 'bg-[#FF3D8B]/10'"
            >
              <HelpCircle 
          ...
          <div class="mt-6 flex items-center justify-end gap-3">
            ...
            <button
              ...
              :class="state.type === 'confirm' ? 'bg-[#DCEEB1] hover:bg-[#DCEEB1]/90' : 'bg-[#FDE047] hover:bg-[#FDE047]/90'"
            >
              {{ state.confirmText }}
            </button>
          </div>
